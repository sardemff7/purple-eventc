...
namespace Purple {
	...
	public class BlistNode {
        ...
        [CCode (cname = "PURPLE_BLIST_NODE_IS_CHAT")]
        public bool is_chat();

        [CCode (cname = "PURPLE_BLIST_NODE_IS_BUDDY")]
        public bool is_buddy();

        [CCode (cname = "PURPLE_BLIST_NODE_IS_GROUP")]
        public bool is_group();

        [CCode (cname = "PURPLE_BLIST_NODE_IS_CONTACT")]
	...
	public class Plugin {
		...
		public unowned Purple.PluginProtocolInfo get_protocol_info ();
